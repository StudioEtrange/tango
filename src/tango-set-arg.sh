...
usage() {
	...
	echo "L     modules|services|plugins list : list available modules, plugins or default defined services within tango context or your application context."
	echo "|"
	...
	echo "L     gen [--module module] [--plugin plugin] [--freeport]: generate compose & env files and create needed files & folders."
