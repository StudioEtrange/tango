...
if [ "${MODE}" = "init" ]; then
    ...
    echo L-- create [$DATA_PATH/$WEB2_ROOT_FOLDER] {/data/$WEB2_ROOT_FOLDER}
    mkdir -p "/data/$WEB2_ROOT_FOLDER"
    echo L-- create [$DATA_PATH/transmission_data] {/data/transmission_data}
    mkdir -p "/data/transmission_data"
    echo L-- create [$DATA_PATH/transmission_download] {/data/transmission_download}
    mkdir -p "/data/transmission_download"
    echo L-- create [$DATA_PATH/transmission_watch] {/data/transmission_watch}
